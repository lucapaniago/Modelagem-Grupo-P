...
function dy = fnl(t,q)
    ...
    dy_5 = 4875.31*(-0.00801894*q(1)^2+0.0160379*q(1)*q(2)+0.00801894*q(2)^2+0.00801894*q(3)^2+0.0160379*q(3)*q(4)-0.00801894*q(4)^2+0.027945*Tau_x+0.012375*Tau_y+0.012375*Tau_z)-0.00102564*(q(1)^2+q(2)^2+q(3)^2+q(4)^2)^2*q(6)+0.234842*q(6)^2+q(5)*(-0.00175665*(q(1)^2+q(2)^2+q(3)^2+q(4)^2)^2+0.234842*q(6)-0.234842*q(7))-0.00102564*(q(1)^2+q(2)^2+q(3)^2+q(4)^2)^2*q(7)-0.234842*q(7)^2;
    dy_6 = 4875.31*(0.00801894*q(1)^2-0.00801894*q(2)^2+0.0160379*q(1)*q(3)-0.00801894*q(3)^2-0.0160379*q(2)*q(4)+0.00801894*q(4)^2+0.012375*Tau_x+0.027945*Tau_y+0.012375*Tau_z)-0.234842*q(5)^2+q(5)*(-0.00102564*(q(1)^2+q(2)^2+q(3)^2+q(4)^2)^2-0.234842*q(6))+q(6)*(-0.00175665*(q(1)^2+q(2)^2+q(3)^2+q(4)^2)^2+0.234842*q(7))-0.00102564*(q(1)^2+q(2)^2+q(3)^2+q(4)^2)^2*q(7)+0.234842*q(7)^2;
    dy_7 = 2437.65*(-0.0320758*q(1)*(q(2)+q(3))+0.0320758*q(2)*q(4)+0.3*(-0.106919*q(3)*q(4)+0.0825*(Tau_x+Tau_y))+0.04239*Tau_z)+0.234842*q(5)^2-0.234842*q(6)^2+q(6)*(-0.00102745*(q(1)^2+q(2)^2+q(3)^2+q(4)^2)^2-0.234842*q(7))+q(5)*(-0.00102564*(q(1)^2+q(2)^2+q(3)^2+q(4)^2)^2+0.234842*q(7))-0.00175665*(q(1)^2+q(2)^2+q(3)^2+q(4)^2)^2*q(7);
